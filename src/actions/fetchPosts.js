  ...
  return {
    ...
    posts: [
      ...
      },
      {
        ...
        "usefulPars": "The flower’s triple stigma, and the adjacent part of the style yield the spice.",
        "medicinalProperties": "Currently some herbalists claim it has anti-cancer and other remarkable properties, but there is no evidence to support such beliefs.",
      ...
      },
      {
        ...
        "usefulPars": "The berries have been used in pickling and in condiments, and are especially used with meats. A form of allspice cured meat was known in the Caribbean as boucan, and European sailors who relied on this staple were called buccaneers. Caribbean cooking utilizes allspice in many dishes; it is of limited popularity elsewhere.",
        "medicinalProperties": "Allspice is used in toiletries and liqueurs, and it used to be added to flannel to make a plaster for treating neuralgia or rheumatism. The eugenol content (which is more characteristic of cloves) can provide a mild analgesic effect.",
      ...
      },
      {
        ...
        "usefulPars": "The seeds have been used widely in cooking, and are popular in spicy cakes. The “oil of anise” is often used in artificial licorice, and gives its distinctive taste to liqueurs such as anisette and raki. Anise is used in many processed foods and in cough medicines, and is often included in pet foods for the flavor it imparts.",
        "medicinalProperties": "Over the centuries, anise has been reported to have numerous medical benefits, but there is no evidence that it offers any pharmacologic benefit. It is thus a flavorful digestive spice that may be soothing, stimulating or carminative (relieving gas) in different individuals, and it is a popular taste in drinks, confections and simple proprietary medicines.",
      ...
      },
      {
        ...
        "usefulPars": "Black pepper is obtained from the unripe green berries of the vine, which become black when they are dried in the sun. YELLOW (or WHITE) PEPPER is obtained from ripe red berries or by peeling off the pericarp from black peppercorns.",
        "medicinalProperties": "The main flavor is from piperine, but other essential oils, including terpenes, contribute to the aroma. Its alkaloids include the pungent tasting chavicine and piperidine.",
      ...
      },
      {
        ...
        "usefulPars": "The aromatic extract contains many essential oil chemicals, some of which have a smell like that of camphor. Thus, its main use is as an adjunctive spice in curries, coffees and other Asian or Middle Eastern foods. It used to be second in expense to saffron, and is known in India as Queen of Spices. However, declining markets and increased production in Guatemala have led to a fall in its value.",
        "medicinalProperties": "Medically, it is used mainly as a flavor and an aid to digestion. It is used more prosaically to treat colds, bronchitis, fevers, inflammatory conditions of the oropharynx, and liver complaints. There is no evidence to support any of these uses.",
      ...
      },
      {
        ...
        "usefulPars": "The spice in the case of both cinnamon and cassia come from bark of the plants.",
        "medicinalProperties": "Cinnamon and cassia extracts have been used medically to treat gastrointestinal problems and as a specific for diarrhea, but their value is marginal. Their use as antimicrobials is of limited relevance, and it is dubious if the presence of cinnamon or cassia in cooked foods retards spoilage if left unrefrigerated in a tropical climate. Nevertheless, cinnamon along with many other spices has antibacterial properties that may be worth exploiting.",
      ...
      },
      {
        ...
        "usefulPars": "All cocoa beans are fermented, dried, roasted, crushed into nibs or pieces, then further ground into a liquid mass usually containing 50% cocoa butter.",
        "medicinalProperties": "The theobromine content may stimulate the brain, since it is an xanithine similar to coffee. Recently, the polyphenols in chocolate have been generously praised as being potent anti-oxidants that may prevent degenerative diseases, thus reducing the guilt sensations of chocaholics. However, true medicinal values have not been established for pure chocolate.",
      ...
      },
      {
        ...
        "usefulPars": "The seeds are used and the stalks are eaten as a vegetable.",
        "medicinalProperties": "No specific medical values have been demonstrated for fennel seeds.",
      ...
      },
      {
        ...
        "usefulPars": "The roots of galangal contain the flavor.",
        "medicinalProperties": "They have no well-defined medicinal use, although they have been advocated for many of the disorders that are treated with ginger. In Germany, herbalists use lesser galangal for dyspepsia biliary symptoms, bowel spasm and angina.",
      ...
      },
      {
        ...
        "usefulPars": "The berries are dried and ground to create the spice.",
        "medicinalProperties": "The sumac bush is related to poison sumac (Rhus vermix); this shrub grows in swampy areas in the USA, and contact with it can produce a rash that is similar to the lesions caused by poison oak and poison ivy.",
      ...
      },
      {
        ...
        "usefulPars": "The spice is the ripe fruit or pulp of the pods of Tamarindus indica.",
        "medicinalProperties": "In practice, no true therapeutic value has been demonstrated.",
      ...
      },
      {
        ...
        "usefulPars": "The rhizome is harvested and ground to make the spice.",
        "medicinalProperties": "Although none of the alleged benefits have been adequately evaluated, turmeric and curcumin are increasingly being promoted as health products.",
