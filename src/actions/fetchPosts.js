    ...
    posts: [
      {
        ...
        "introduction": "莳萝原产于亚洲西南部和中部。莳萝籽的外形呈扁椭圆形，中部为棕色，边缘处颜色较浅。莳萝籽的味道辛香甘甜，有水芹科特有的刺激香味以及像烧焦般的辛辣味。可以整颗或粉碎后用于烹饪。",
      ...
      },
      {
        ...
        "cookingUsage": "中国人在很多菜肴中使用八角茴香，尤其是使用在鸭、鸡和猪肉中来去腥增香，或是用于炖菜或焖菜中提味。研磨后的八角茴香还可以加入咖啡和茶中增强风味。八角也是五香粉的五种成分之一。"
      },
      {
        "id": 3,
        "name": "众香子",
      ...
      },
      {
        ...
        "introduction": "肉桂被认为是由腓尼基商人首次将其带到了中东地区，随后在欧洲被广泛使用。肉桂味道芳香而温和，有一种木本的芳香气味。肉桂呈浅棕色且较薄。烹饪中若不想食物中有肉桂粉，可以使用肉桂棒代替。",
        "medicalProperties": "肉桂是一种非常好的抗氧化原料。曾被列为含抗氧化剂最多的食物中的第四位。如果每天在食物中加入一些桂皮，则足够身体抗氧化的需要。桂皮具有促进消化，增进食欲的功效，同时也可以帮助消除饥饿感。它是腺系统的强促进剂，能够帮助减轻感冒和流感的症状。",
      ...
      },
      {
        ...
        "cookingUsage": "藏红花常用来给食物着色和调味，它是西班牙什锦菜饭(Paella)、法国红烧肉(Bouillabaisse)和意大利米兰干酪洋葱调味饭(Risotto alla Milanese)的必备成分。藏红花还可以给贝类和鱼类菜肴调味。使用前应将其打碎，用少量热水浸泡，再把过滤后的液体加入菜肴中。或者，你可以将藏红花丝烤干后弄碎直接放入菜肴中。少量的藏红花就能够给菜肴增添美味，提供花一般的芳香，带来金黄的色泽。"
      },
      {
        "id": 9,
        "name": "香草",
        ...
        "cookingUsage": "香草常用来给芥末、冰激凌、蛋糕、饼干、餐后甜点、蛋奶酥和奶油饮品调味，如冰咖啡或热巧克力。"
      },
      {
        "id": 10,
        "name": "大茴香",
      ...
      },
      {
        ...
        "cookingUsage": "葫芦巴常被用于咖喱中。研磨好的籽可以可以用在卤汁，调味品和酸辣酱中。注意孕妇不能食用葫芦巴。"
      },
      {
        "id": 13,
        "name": "芫荽",
      ...
      },
      {
        ...
        "cookingUsage": "孜然是很多北非蒸粗麦粉类菜肴（将碎小麦、调味肉、蔬菜、鹰嘴豆泥和葡萄干一起蒸的食物）的重要配料。孜然可以给肉制品和干酪调味。在西班牙，它和番红花、肉桂一起用在砂锅菜中。在得克萨斯州，它被用于墨西哥辣味牛肉中。"
      },
      {
        "id": 15,
        "name": "姜黄",
      ...
      },
      {
        ...
        "cookingUsage": "柠檬香草尝尝被用于茶饮、炖汤和咖喱中。它还可以被用于给鸡、鱼、牛肉和海鲜调味。柠檬香草和辣椒、大蒜、葱一起使用最佳。"
      },
      {
        "id": 18,
        "name": "漆树",
        ...
        "introduction": "漆树原产于中东，它的果实被采摘干燥后用于烹饪。颜色呈铁锈红色。漆树具有柠檬般酸酸的味道。常常磨成粉后使用。",
